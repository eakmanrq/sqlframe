...
from sqlframe.gizmosql import GizmoSQLDataFrameReader


@pytest.fixture
def mock_gizmosql_session():
    """Create a mock GizmoSQLSession for testing."""
    session = MagicMock()
    session.input_dialect = "gizmosql"
...
@pytest.fixture
def reader(mock_gizmosql_session):
    """Create a DataFrameReader instance for testing."""
    return GizmoSQLDataFrameReader(mock_gizmosql_session)
...
@patch.object(GizmoSQLDataFrameReader, "load")
